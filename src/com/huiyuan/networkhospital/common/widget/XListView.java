 ...
 */
package com.huiyuan.networkhospital.common.widget;
/**
 * 在109行自己定了个高度，避免刷新的时候直接被盖了，不需要的时候直接stop刷新
 * 83行是scview与Xlistview复用的情况
 */
...
//    }//测试listview长度并且计算出来可以设置出listview的长度，，，，，在ScrollView与listview一起使用的时候
//	//http://www.xuebuyuan.com/2191777.html第四条
...
//						Log.e("mHeaderViewHeight", mHeaderViewHeight+"");
	...
	private void resetHeaderHeight() {
		...
		Log.e("3", ""+height+"!"+(finalHeight - height)+"!"+
				SCROLL_DURATION);
		Log.e("4", mPullRefreshing+"");
		Log.e("5", height+"");
