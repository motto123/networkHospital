 ...
 */
package com.huiyuan.networkhospital.module.huanxin.utils;
...
//            yuv_Rotate90lr = new byte[mwidth * mheight * bitsperpixel / 8];
    ...
    boolean isScreenOriatationPortrait() {
        return NApplication.applicationContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
