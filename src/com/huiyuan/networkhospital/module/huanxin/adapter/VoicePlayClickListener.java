...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((ChatMainActivity) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((ChatMainActivity) activity).playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			if (((ChatMainActivity) activity).playMsgId != null && ((ChatMainActivity) activity).playMsgId.equals(message.getMsgId())) {
