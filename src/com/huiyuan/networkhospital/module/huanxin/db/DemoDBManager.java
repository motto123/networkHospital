package com.huiyuan.networkhospital.module.huanxin.db;
...
import com.huiyuan.networkhospital.module.huanxin.domain.InviteMessage;
import com.huiyuan.networkhospital.module.huanxin.domain.InviteMessage.InviteMesageStatus;
    ...
    synchronized public Map<String, User> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(GlobalConstant.NEW_FRIENDS_USERNAME) || username.equals(GlobalConstant.GROUP_USERNAME)
                        || username.equals(GlobalConstant.CHAT_ROOM)|| username.equals(GlobalConstant.CHAT_ROBOT)) {
                    user.setHeader("");
